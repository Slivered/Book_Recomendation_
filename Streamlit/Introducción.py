...
st.markdown("- Análisis: Utilicé las herramientas de visualización de datos para crear gráficas y un filtro interactivo para representar y explorar los datos en profundidad.")
st.markdown("- Modelaje: Como resultado de este análisis, preparé un modelo recomendador que utiliza técnicas de machine learning para sugerir contenido similar a una película o libro de entrada.")
